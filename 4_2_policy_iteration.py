...
def policy_evaluation(policy_matrix, env, gamma=0.9, theta=1e-6):
    """
...
def policy_iteration_algorithm(env, gamma=0.9, theta=1e-6):
    ...
    while True:
        ...
        V = policy_evaluation(policy_matrix, env, gamma, theta)
...
def show_policy(env, V, policy_matrix):
    ...
    plt.draw() 
    plt.savefig("policy_iteration_visualization.png", dpi=300, bbox_inches='tight')
